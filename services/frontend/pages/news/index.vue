  ...
  <div>
    <div class="pt-8 pb-20 px-4 sm:px-6 lg:pt-12 lg:pb-28 lg:px-8">
      <div class="relative max-w-lg mx-auto lg:max-w-7xl">
        <div>
          <h2
            class="text-3xl leading-9 tracking-tight font-extrabold text-gray-200 sm:text-4xl sm:leading-10"
          >
            Press
          </h2>
          <div
          ...
          >
            ...
            <form class="mt-6 flex lg:mt-0 lg:justify-end">
              <input
                ...
                type="email"
                required
                class="appearance-none w-full px-4 py-2 border border-gray-700 text-base leading-6 rounded-md text-gray-100 bg-gray-900 placeholder-gray-500 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out lg:max-w-xs"
        ...
        <div
          class="mt-6 grid gap-16 border-t-2 border-gray-600 pt-10 lg:grid-cols-2 lg:gap-x-5 lg:gap-y-12"
        >
          <div v-for="article in articles" :key="article.title">
            ...
            >
              <h3
                class="mt-2 text-xl leading-7 font-semibold text-gray-200"
              >
                {{ article.title1 }} {{ article.title2 }}
              </h3>
              <p
                class="mt-3 text-base leading-6 text-gray-400"
              >
                {{ article.description }}
              </p>
            </NuxtLink>
            <div class="mt-3">
              <NuxtLink
                :to="{ name: 'news-slug', params: { slug: article.slug } }"
                class="text-base leading-6 font-semibold text-red-600 hover:text-gray-300 transition ease-in-out duration-150"
              >
                Read full story
              </NuxtLink>
            </div>
