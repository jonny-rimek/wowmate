		...
		<div class="max-w-4xl mx-auto">
			<div class="lg:flex lg:items-center lg:justify-between">
				<div class="flex-1 min-w-0">
					<h2
						class="text-2xl font-bold leading-7 text-gray-900 sm:text-3xl sm:leading-9 sm:truncate float-left mr-4"
					>
						Wrathion
					</h2>
					<div class="mt-1 flex flex-col sm:mt-0 sm:flex-row sm:flex-wrap">
						...
						>
							...
							killed at 23:37 on the 31.03.2020
						</div>
						<div
							class="mt-2 flex items-center text-sm leading-5 text-gray-500 sm:mr-6"
						>
				...
				<div class="hidden sm:block">
					<div class="border-b border-gray-200">
						<nav class="-mb-px flex">
							<a
								href="#"
								class="whitespace-no-wrap py-4 px-1 border-b-2 border-red-500 font-medium text-sm leading-5 text-gray-700 focus:outline-none"
								>Damage</a
							>
							<a
								href="#"
					...
					>
						<table class="min-w-full table-fixed">
							<thead>
								<tr>
									<th
										class="px-6 py-3 border-b border-gray-200 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider w-1/6"
									>
										Name
									</th>
									<th
									...
									<th
										class="px-6 py-3 border-b border-gray-200 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider w-8/12"
									>
										damage
									</th>
									<th
										class="px-6 py-3 border-b border-gray-200 bg-gray-50 w-1/12"
									></th>
								</tr>
							</thead>
							<tbody class="bg-white">
								<tr>
									...
									>
										<a
											href="#"
											class="text-gray-500 hover:text-indigo-900 focus:outline-none focus:underline"
											>More</a
										>
									</td>
								</tr>
