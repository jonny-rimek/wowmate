...
interface Props extends cdk.StackProps {
	...
	getKeysPerDungeonLambda: lambda.Function
	api: HttpApi
	s3: s3.Bucket
...
Those are all customer facing lambdas that access the database, ergo errors should be 0, no throttles and duration should be as low as possible.
				...
				new GraphWidget({
					title: 'Invocations',
					left: [
						props.getKeysLambda.metricInvocations({period: cdk.Duration.minutes(5)}),
						props.getKeysPerDungeonLambda.metricInvocations({period: cdk.Duration.minutes(5)}),
					],
					stacked: false,
					width: 4,
				}),
				new GraphWidget({
					title: 'Errors',
					left: [
						props.getKeysLambda.metricErrors({period: cdk.Duration.minutes(5)}),
						props.getKeysPerDungeonLambda.metricErrors({period: cdk.Duration.minutes(5)}),
					],
					stacked: false,
					width: 4
				}),
				new GraphWidget({
					title: 'Duration',
					left: [
						props.getKeysLambda.metricDuration({period: cdk.Duration.minutes(5)}),
						props.getKeysPerDungeonLambda.metricDuration({period: cdk.Duration.minutes(5)}),
					],
					stacked: false,
					width: 4
				}),
				new GraphWidget({
					title: 'Throttles',
					left: [
						props.getKeysLambda.metricThrottles({period: cdk.Duration.minutes(5)}),
						props.getKeysPerDungeonLambda.metricThrottles({period: cdk.Duration.minutes(5)}),
					],
					stacked: false,
					width: 4
				}),
				new GraphWidget({
					...
					left: [
						props.getKeysLambda.metric('ConcurrentExecutions',{ statistic: 'Maximum', period: cdk.Duration.minutes(5) }),
						props.getKeysPerDungeonLambda.metric('ConcurrentExecutions',{ statistic: 'Maximum', period: cdk.Duration.minutes(5) }),
					],
					stacked: false,
					width: 4
				}),
