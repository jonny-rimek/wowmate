...
Those are all customer facing lambdas that access the database, ergo errors should be 0, no throttles and duration should be as low as possible.
				...
				new GraphWidget({
					title: 'Invocations',
					left: [
						props.topDamageLambda.metricInvocations({period: cdk.Duration.minutes(5)}),
					],
					stacked: false,
					width: 4,
				}),
				new GraphWidget({
					title: 'Errors',
					left: [
						props.topDamageLambda.metricErrors({period: cdk.Duration.minutes(5)}),
					],
					stacked: false,
					width: 4
				}),
				new GraphWidget({
					title: 'Duration',
					left: [
						props.topDamageLambda.metricDuration({period: cdk.Duration.minutes(5)}),
					],
					stacked: false,
					width: 4
				}),
				new GraphWidget({
					title: 'Throttles',
					left: [
						props.topDamageLambda.metricThrottles({period: cdk.Duration.minutes(5)}),
					],
					stacked: false,
					width: 4
				}),
				new GraphWidget({
					...
					left: [
						props.topDamageLambda.metric('ConcurrentExecutions',{ statistic: 'Maximum', period: cdk.Duration.minutes(5) }),
					],
					stacked: false,
					width: 4
				}),
